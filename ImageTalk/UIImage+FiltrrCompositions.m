...
-(id) e12{
    ...
    topImage = [[topImage tintWithMinRGB:minrgb MaxRGB:maxrgb] saturationByFactor:0.02];
    
    UIImage *newImage = [[[[[self adjustRedChannel:0.1 GreenChannel:0.7 BlueChannel:0.4] saturationByFactor:0.02] contrastByFactor:0.85] brightnessByFactor:1.2] sepia];
    newImage = [newImage multiply:topImage];
...
-(id) e13{
//contrast(1.2) saturate(1.35);filter:contrast(1.2) saturate(1.35)
    //rgba(127,187,227,.2);
    UIImage *topImage = [self duplicate];
    RGBA minrgb, maxrgb;
    ...
    topImage = [[topImage tintWithMinRGB:minrgb MaxRGB:maxrgb] saturationByFactor:1.2];
    
    UIImage *newImage = [[[self adjustRedChannel:0.1 GreenChannel:0.7 BlueChannel:0.4] contrastByFactor:1.2]saturationByFactor:1.35 ] ;
    newImage = [newImage multiply:topImage];
