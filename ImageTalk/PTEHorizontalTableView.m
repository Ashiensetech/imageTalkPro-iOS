...
- (void)refreshOrientation
{
    ...
    self.tableView.frame = CGRectMake(self.frame.origin.x,self.frame.origin.y, self.bounds.size.width, self.bounds.size.height);
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        int xOrigin	= (cell.bounds.size.width - cell.bounds.size.height);
        int yOrigin	= (cell.bounds.size.height - cell.bounds.size.width);
